...
class Header3 extends React.Component {
    render() {
        return (
            <>
                {/* Header */}
                <header className="header header_style2 header_style3">
                                ...
                                <div className="col-lg-4 col-md-7 col-sm-7">
                                    <div className="top_right_menu pull-right">
                                        <ul className="cart_wishlist">
                                            <li>
                                                <Link to="/wishlist">
                                                    <i className="fa fa-heart-o" aria-hidden="true" /> Wishlist
                                                    <span className="wish_item">(0)</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="#" id="cart-item-bar">
                                                    <i className="fab fa-opencart" aria-hidden="true" /> 3 items
                                                    <span className="item_price">| $310.00</span>
                                                </Link>
                                                <div className="cart_header_widget">
                                                    ...
                                                    <div className="mini_cart_btns">
                                                        ...
                                                        <Link to="/checkout" className="btn btn-sm outline">
                                                            Checkout
                                                        </Link>
                                                    </div>
                                                    <div
                                                        className="no_product_cart"
                                                        style={{ display: "none" }}
                                                    >
                                        ...
                                        >
                                            <ul className="navbar-nav mr-auto">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuAccessor"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                                    Metal Classic Sunglasses
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                                    Magic Women's Wallet
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuWatchs"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuOutdoor"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuHealth"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                            ...
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                                    Nutrilite Joint Health
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                                    Face Facial Massager
                                                                </Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuPages"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuBlogs"
                                                    >
                                                        <ul>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <Link className="dropdown-item" to="/blog-grid-large">
                                                                    Grid Large View
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item" to="/blog-grid-left">
                                                                    Grid Left View
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item" to="/blog-grid-right">
                                                                    Grid Right View
                                                                </Link>
                                                            </li>
                                                        </ul>
