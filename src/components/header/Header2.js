...
class Header2 extends React.Component {
    render() {
        return (
            <>
                {/* Header */}
                <header className="header header_style2">
                                ...
                                <div className="col-lg-4 col-md-7 col-sm-7">
                                    <div className="top_right_menu pull-right">
                                        <ul className="cart_wishlist">
                                            <li>
                                                <Link to="/wishlist">
                                                    Wishlist <span className="wish_item">(0)</span>
                                                </Link>
                                            </li>
                                            <li className="divider_line">/</li>
                                            <li>
                                        ...
                                        >
                                            <ul className="navbar-nav mr-auto">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuApparel"
                                                    >
                                                        <ul>
                                                            <li>
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuJewelry"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuSport"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
                                                ...
                                                <li className="nav-item dropdown">
                                                    ...
                                                    <div
                                                        className="dropdown-menu"
                                                        aria-labelledby="navbarDropdownMenuBeauty"
                                                    >
                                                        <ul>
                                                            <li>
                                                                <Link className="dropdown-item" to="/product">
