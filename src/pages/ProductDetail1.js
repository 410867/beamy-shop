    ...
    render() {
        return (
            <>
                ...
                <section className="section_padding_small product_detail product_detail_1">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <div className="product_detail_slider1">
                                    <div id="detail_slider2" className="flexslider">
                                        <ul className="slides">
                                            <li><img src="./assets/images/600x600.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/600x600.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/600x600.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/600x600.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/600x600.jpg" alt="image" /></li>
                                    ...
                                    <div id="detail_carousel2" className="flexslider">
                                        <ul className="slides">
                                            <li><img src="./assets/images/150x150.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/150x150.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/150x150.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/150x150.jpg" alt="image" /></li>
                                            <li><img src="./assets/images/150x150.jpg" alt="image" /></li>
                            ...
                            <div className="col-lg-6">
                                <div className="product-description">
                                    <ol className="breadcrumb breadcrumb_border">
                            ...
                            <div className="col-lg-12">
                                ...
                                <div className="product_detail_tab">
                                    <ul className="nav nav-tabs">
                                        ...
                                        <li className="nav-item">
                                            <Link to="#review" data-bs-toggle="tab" className="nav-link" aria-expanded="true" >
                                                Review (2)
                                            </Link>
                                        </li>
                                    </ul>
                ...
                {/* Similar Product */}
                <section className="section_padding pt-0 similar_products">
                    <div className="container">
                        <div className="row">
