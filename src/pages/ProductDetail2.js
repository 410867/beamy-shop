    ...
    render() {
        return (
            <>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="font_30_normal">Drapes Cotton Printed Salwar Suit</h2>
                ...
                <section className="section_padding_small product_detail product_detail_2">
                    <div className="container">
                        {/* Productes Detail Row*/}
                        <div className="row">
                            <div className="col-lg-6">
                                {/* Productes Detail Slider 2 Start*/}
                                <div className="product_detail_slider2">
                                    <div id="detail_slider2" className="flexslider">
                                        <ul className="slides">
                                            <li>
                                    ...
                                    <div id="detail_carousel2" className="flexslider">
                                        <ul className="slides">
                                            <li>
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="tab-pane" id="review">
                                            <div className="articale_comments">
                                                <div id="comments">
                                                    <h4 className="block-head">2 Review</h4>
                    ...
                    />
                                ...
                                {/* Productes Description End Here*/}
                            </div>
                            <div className="col-lg-3">
                                {/* Similar Product2 Slider Start Here*/}
                                <div className="similar_product2">
                                    <h5 className="inner_title">Similar Products</h5>
                                    <div id="similar_products_slider2" className="next_prev_style1">
                                ...
                                {/* Similar Product2 Slider End Here*/}
                            </div>
                        </div>
                    </div>
                </section>
